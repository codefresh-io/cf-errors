...
describe('CFErrors tests', function () {
    ...
    describe('constructor', function () {
        ...
        describe('positive', function () {
            ...
            it('should create an error when not using a specific name', function(){
                var error = new CFError({message: "my error"});
    ...
    describe('inherit', function(){
        ...
        it('should inherit previous error type', function(){

            var err = new Error("my error");
            var error = new CFError(Errors.Inherit, {
                cause: err
            });
        ...
        it('should inherit previous error type', function(){
            ...
            var err = new CFError(Errors.Http.BadRequest);
            var error = new CFError(Errors.Inherit, {
                cause: err
            });
        ...
        it('error name should be Error in case cause does not exist', function(){
        ...
        it('error name should be Error in case cause does not have name property', function(){
